    ...
    return (
        ...
        <div className="container">
            ...
            {Array(10).fill(0).map((x, index) => {
                    return(
                    <div className='seatPlace2'><Seat id={(index+1)} isTaken={takenSeats.includes(index+1)} ChangeCount={updateSelectedCount} /></div>)})
                }
            </div>
            <div className="row">
            {Array(10).fill(0).map((x, index) => {
                    return(
                    <div className='seatPlace2'><Seat id={(index+11)} isTaken={takenSeats.includes(index+11)} ChangeCount={updateSelectedCount} /></div>)})
                }
            </div>
            <div className="row">
            {Array(10).fill(0).map((x, index) => {
                    return(
                    <div className='seatPlace2'><Seat id={(index+21)} isTaken={takenSeats.includes(index+21)} ChangeCount={updateSelectedCount} /></div>)})
                }
            </div>
            <div className="row">
            {Array(10).fill(0).map((x, index) => {
                    return(
                    <div className='seatPlace2'><Seat id={(index+31)} isTaken={takenSeats.includes(index+31)} ChangeCount={updateSelectedCount} /></div>)})
                }
            </div>
            <div className="row">
            {Array(10).fill(0).map((x, index) => {
                    return(
                    <div className='seatPlace2'><Seat id={(index+41)} isTaken={takenSeats.includes(index+41)} ChangeCount={updateSelectedCount} /></div>)})
                }
            </div>
            <div className="row">
            {Array(10).fill(0).map((x, index) => {
                    return(
                    <div className='seatPlace2'><Seat id={(index+51)} isTaken={takenSeats.includes(index+51)} ChangeCount={updateSelectedCount} /></div>)})
                }
            </div>
            <div className="row">
            {Array(10).fill(0).map((x, index) => {
                    return(
                    <div className='seatPlace2'><Seat id={(index+61)} isTaken={takenSeats.includes(index+61)} ChangeCount={updateSelectedCount} /></div>)})
                }
            </div>
            <div className="row">
            {Array(10).fill(0).map((x, index) => {
                    return(
                    <div className='seatPlace2'><Seat id={(index+71)} isTaken={takenSeats.includes(index+71)} ChangeCount={updateSelectedCount} /></div>)})
                }
            </div>
            <div className="row">
            {Array(10).fill(0).map((x, index) => {
                    return(
                    <div className='seatPlace2'><Seat id={(index+81)} isTaken={takenSeats.includes(index+81)} ChangeCount={updateSelectedCount} /></div>)})
                }
            </div>
        </div>
        <p className="text">
