...
export default function MovieAdd(params) {
    ...
    return (
        <div class="adds">
            ...
            <div class="field4"><input type="number" min="30" max="300" autoComplete="false" id="length" placeholder="Długość" onChange={e => setCzas(e.target.value)} required ></input></div>
